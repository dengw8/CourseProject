...
namespace player
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            bottombar.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(105, 105, 105, 0));
            topbar.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(105, 105, 105, 0));
            var view = ApplicationView.GetForCurrentView();
            view.TitleBar.ButtonBackgroundColor = Windows.UI.Color.FromArgb(105, 105, 105, 0);
        }
